...
public partial class LibraryGenresView : UserControl
{
    private EventHandler? _pendingScrollRestore;

    public LibraryGenresView()
    {
        InitializeComponent();
    }
    ...
    protected override void OnDetachedFromVisualTree(VisualTreeAttachmentEventArgs e)
    {
        ...
        if (DataContext is LibraryGenresViewModel vm)
        {
    ...
    protected override void OnAttachedToVisualTree(VisualTreeAttachmentEventArgs e)
    {
        ...
        if (DataContext is LibraryGenresViewModel vm && vm.SavedScrollOffset > 0)
        {
            Opacity = 0;
